//! Multi-objective benchmark problems from the ZDT test suite.
//!
//! These are two-objective problems with known Pareto fronts, commonly
//! used to evaluate multi-objective optimizers like NSGA-II.
...
// True front: f2 = 1 - sqrt(f1), f1 in [0, 1]
// ---------------------------------------------------------------------------
...
// True front: f2 = 1 - f1^2, f1 in [0, 1]
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// ZDT3: disconnected Pareto front (five separate segments)
// The sine term creates gaps in the front.
// ---------------------------------------------------------------------------

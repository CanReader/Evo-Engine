...
// ---------------------------------------------------------------------------
// Polynomial mutation (pairs with SBX crossover)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Cauchy mutation (heavier tails → better at escaping local optima)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Adaptive mutation — step size self-adapts (1/5 success rule variant)
// ---------------------------------------------------------------------------
...
impl AdaptiveMutator {
    ...
    pub fn mutate(&mut self, genome: &mut [f64], bounds: &[(f64, f64)], rng: &mut impl Rng) {
...
// ---------------------------------------------------------------------------
// Non-uniform mutation (decreasing perturbation over generations)
// ---------------------------------------------------------------------------
...
pub fn non_uniform_mutation(
    ...
    b: f64, // shape parameter (typically 2-5)
    prob: f64,
    rng: &mut impl Rng,
) {
